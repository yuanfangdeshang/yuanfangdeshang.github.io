...
- Market microstructure and high-frequency return prediction
- Fixed-income relative value and yield-spread mean reversion
...
- **High-Frequency Stock Return Prediction:** Built an E-stream / Board-stream Ridge framework to combine order-book and sector lead-lag signals, achieving IC 0.1994 for 5-minute return prediction.
- **Regime-routed Transformer:** Developed a normal/extreme dual-expert Transformer for high-volatility minute-level return prediction, with external validation on 10.6M rows.
- **Domestic Macro Asset Allocation:** Derived analytical gradients and Jacobians for rolling Markowitz optimization, cutting a 17-year rolling backtest from nearly 1 hour to 90 seconds.

For a concise version of my background, please see my [CV](/profile/cv/) or download my [resume PDF](/files/wx-profile-resume.pdf).
